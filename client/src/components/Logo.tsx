    ...
    >
      <defs>
        <linearGradient id="ikid-brand-grad" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0" stopColor="#8a1f0c" />
          <stop offset="1" stopColor="#c62f14" />
        </linearGradient>
      </defs>
      ...
      <circle cx="16" cy="13" r="5.5" fill="#8a1f0c" />
      <circle cx="71" cy="13" r="5.5" fill="#c62f14" />
      <path d="M16,13 C34,-8 53,-8 71,13" fill="none" stroke="#c62f14" strokeWidth="2.5" strokeDasharray="6 6" />
    </svg>
  );
}
...
export function IkidMark({ size = 28 }: { size?: number }) {
  return (
    <svg viewBox="0 0 96 96" width={size} height={size} role="img" aria-label="ikid mark" style={{ display: "block" }}>
      <circle cx="26" cy="68" r="11" fill="#8a1f0c" />
      <circle cx="70" cy="30" r="11" fill="#c62f14" />
      <path d="M33,58 C44,38 52,46 62,38" fill="none" stroke="#c62f14" strokeWidth="5" strokeDasharray="8 8" strokeLinecap="round" />
    </svg>
  );
}
